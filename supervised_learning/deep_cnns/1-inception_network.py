...
def inception_network():
    ...
    x8 = K.layers.AveragePooling2D(pool_size=(7, 7), strides=(1, 1))(x7)
    ...
    union = K.layers.MaxPool2D(pool_size=(7, 7), strides=(1, 1))(x13)
    # back to inception blocks
    ...
    x9 = K.layers.Dense(units=1000, activation='softmax')(y)
    model = K.Model(inputs=X, outputs=x9)
    return model
